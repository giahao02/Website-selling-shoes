    ...
    <h2>Thêm sản phẩm</h2>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="input-form">
                    ...
                    <input type="text" name="prd_name"  class="form-control" value="<?php echo $hungsp['tenSP'] ?>" required >
                </div>
                ...
                <div class="input-form">
                    ...
                    <input type="number" name="price"  class="form-control" value="<?php echo $hungsp['gia'] ?>" required >
                </div>

                <div class="input-form">
                    <span>SL sản phẩm</span>
                    <input type="number" name="quantity"  class="form-control" value="<?php echo $hungsp['soLuong'] ?>" required >
                </div>
                <div class="input-form" align="center">
                    <input class="addsp" name="sbm" type="submit" value="Sửa sản phẩm">
                    </div>
            </form>
