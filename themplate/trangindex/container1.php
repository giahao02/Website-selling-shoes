            ...
            <div class="grid">
                <div class="grid__row app__content">
                    <div class="grid__column-12">
                            ...
                            ?>
                                <div class="grid__column-2-4">  
                                    <div class="home-product-img">
                                        <a href="./themplate/trangindex/chitietsanpham.php?idsp=<?php echo $row['idSP']?>" class="home-product-item"><div class="home-product-item__img" >
                                    ...
                                    <?php if(isset($_SESSION['tenTK']) && $_SESSION['tenTK']  && $checkadmin['idQuyen']!=0  && $checkadmin['idQuyen'] !=1) {?>
                                        ...
                                        <input type="number" name="soluong" min="1" max="<?php echo $row['soLuong']; ?>" value="1" >
                        ...
                        <div class="home-product">
                            ...
                            ?>
                                <div class="grid__column-2-4">  
                                    <div class="home-product-img">
                                        <a href="chitietsanpham.php" class="home-product-item"><div class="home-product-item__img" >
                                        <img style="width:250px;height:200px;" src="./Image/sanpham/<?php echo $row['img'];?>">
                                    </div></a>
                                    </div>
                                    <h4>
                    ...
                    <ul class="pagination home-product-pagination">
                        ...
                        <li class="pagination-item"><a href="./index.php?page=<?php echo $current_page-1 ?>" class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-left"></i></a></li>
                            <?php } ?>
                            <?php 
                            for($page=1;$page<=$tongtrang;$page++){
                                echo  '<li class="pagination-item"> <a  id="page'.$page.'" href="./index.php?page='.$page.'" class="pagination-item__link ">'.$page.'</a> </li>' ;
                             }?>
                             <?php if($current_page<$tongtrang){?>
                        <li class="pagination-item"> <a href="./index.php?page=<?php echo $current_page+1 ?> " class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-right"></i></a></li>      
                        <?php } ?>
