...
if(isset($_GET['idsp'])){
    $idsp=$_GET['idsp'];
    $sql="SELECT * FROM sanpham,thuonghieu WHERE idSP='$idsp' AND sanpham.idTH=thuonghieu.idTH ";
    $query=data::executeQuery($sql);
    $dosp=mysqli_fetch_array($query);
}
...
<head>
    ...
    <title><?php if(isset($_GET['idsp'])) {echo $dosp['tenSP'];} ?></title>
...
<form action=".././timkiem/timkiemcoban.php">
            ...
            <div class="grid__row app__content">
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="product-slide" >
                        <div class="slide1" style="display:block;"><img class="slide_img"  src="../.././Image/sanpham/<?php if(isset($_GET['idsp'])) echo $dosp['img']; ?>"></div>
                    </div>
                </div>
                <div class="grid__column-6 product" style="width: 480px;">
                    <div class="heading-product__name">
                        <span><?php if(isset($_GET['idsp'])) echo $dosp['tenSP']; ?></span>
                    </div>
                    ...
                    <div class="container-product">
                        <div class="container-product__price"><?php if(isset($_GET['idsp'])) echo $dosp['gia']; ?>$</div>
                    </div>
                    
                    <div class="description">
                        <p>Đồng hồ  <b><?php if(isset($_GET['idsp'])) echo $dosp['tenSP']; ?></b> được chế tác từ linh kiện và vật liệu cao cấp, đạt tiêu chuẩn đồng hồ Thụy Sĩ trứ danh. Với thiết kế mặt số hiện đại, tinh tế mang tới cho nam giới phong cách thời trang sang trọng, lịch lãm khác biệt.</p>
                    </div>
                    <div style="font-weight: bold;">
                        <p>Số lượng: <?php if(isset($_GET['idsp'])) echo $dosp['soLuong']; ?></p>
                    </div>
                    <?php if(isset($_SESSION['tenTK']) && $_SESSION['tenTK'] && $checkadmin['idQuyen'] !=0 && $checkadmin['idQuyen'] !=1 ) {?>
                        <?php if($row['soLuong'] >0){ ?>
                                        ...
                                        <input type="hidden" name="tensp" value="<?php echo $dosp['tenSP'] ?>" >
                                        <input type="hidden" name="gia" value="<?php echo $dosp['gia'] ?>" >
                                        <input type="hidden" name="hinh" value="<?php echo $dosp['img'];?>" >
                            ...
                            <div class="product-decribe__css">
                                ...
                                <div class="product-decribe__information">
                                    <div class="product-decribe__information-category">
                                        ...
                                        <div class="product-catogory__heading-details"><a class="product-catogory__heading-test" ><?php if(isset($_GET['idsp'])) echo $dosp['tenTH']; ?></a></div>
                                    </div>
    ...
    Mặt kính và vỏ: <b><?php if(isset($_GET['idsp'])) echo $dosp['tenSP']; ?></b> được thiết kế với mặt kính nhựa. Vỏ đồng hồ cũng là một loại nhựa case/bezel (Resin) không chỉ nhẹ mà còn có khả năng chống sốc, dai nhưng lại cứng và rất bền, lâu lão hóa giúp chiếc đồng hồ bền lâu được cùng với thời gian. Vỏ đồng hồ điện tử được mạ vàng cao cấp tạo độ sang trọng cho người đeo.
