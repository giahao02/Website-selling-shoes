...
<form action=".././timkiem/timkiemcoban.php">
    ...
    <button class="header__search-btn" type="submit" ></a> <i class="header__search-btn-icon fas fa-search"></i> </button>
                ...
                <ul>
                    ...
                    <li><a class="active" href="#">Thương hiệu</a>
                        <ul class="sub-menu">
                            ...
                            <li><a class="catagory-item__link" href="Fossil.php">Fossil</a></li>
        ...
        <?php include_once('contentFo.php') ?>
...
<script><?php
    if(!isset($_SESSION['tenTK'])){?>
    const carts = document.querySelectorAll('.home-product-item__cart-current1');
    for (let i = 0; i < carts.length; i++)
{
    carts[i].addEventListener('click', () => {
            alert("Register before buy");
    })
}
   <?php } ?></script>
