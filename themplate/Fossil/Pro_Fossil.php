                            ...
                            <form onclick="updatecart()">
                                <table>
                                    <tbody class="cart-items">
                                        <tr class="cart-row">
                                            <td><span class="title"> Fossil FS5404</span></td>
                                            <td><p><span class="prices" onclick="">3.299.999</span><sup>đ</sup></p></td>
            ...
            <div class="grid__row app__content">
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="product-slide" >
                        <div class="slide1"><img class="slide_img"  src="../Image/Fossil/Fossil FS5404.jpg"></div>
                        <div class="slide1"><img class="slide_img" src="../Image/Fossil/FOSSIL-FS5404-2-399x399.jpg"></div>
                        <div class="slide1"><img class="slide_img"  src="../Image/Fossil/FOSSIL-FS5404-3.jpg"></div>
                        <a class="prev" onclick="plusSlides(-1)">❮</a>
                        <a class="next" onclick="plusSlides(1)">❯</a>
                    </div>
                    <div class="picture-slide">
                        <div class="picture">
                            <div class="picture1"><img class="change-img" onclick="currentSlide(1);" src="../Image/Fossil/Fossil FS5404.jpg"></div>
                            <div class="picture1" ><img class="change-img" onclick="currentSlide(2);" src="../Image/Fossil/FOSSIL-FS5404-2-399x399.jpg"></div>
                            <div class="picture1"><img class="change-img" onclick="currentSlide(3);" src="../Image/Fossil/FOSSIL-FS5404-3.jpg"></div>
                ...
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="container-product">
                        <div class="container-product__price">3.299.999 VNĐ</div>
                    </div>
                    
                    <div class="description">
                        <p>Đồng hồ nữ <b>Fossil FS5404</b> thiết kế theo lối dành cho người yêu thích sự giản dị, các vạch số cùng vạch số đều được gia công kiểu dáng mỏng đầy tinh tế khi phối cùng dây đeo bằng da có vân đầy lịch lãm.</p>
                    </div>
