                ...
                <div class="grid__row app__content">
                    ...
                    while($row=mysqli_fetch_array($result2)){
                        ...
                        $output .='<ul class="pagination home-product-pagination">';
                             if($current_page>1){
                                $output .=' <li class="pagination-item"><a href="Tissot.php?page=' . ($current_page-1). '" class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-left"></i></a></li>';
                            }
                        
                            for($page=1;$page<=$tongtrang;$page++){
                                $output .=  '<li class="pagination-item"> <a  id="page'.($page).'" href="Tissot.php?page='.($page).'" class="pagination-item__link ">'.$page.'</a> </li>' ;
                             }
                              if($current_page<$tongtrang){
                                $output .='   <li class="pagination-item"> <a href="Tissot.php?page=' . ($current_page+1).'" class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-right"></i></a></li>';     
                        } 
