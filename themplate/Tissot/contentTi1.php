            ...
            <div class="grid">
                <div class="grid__row app__content">
                    ...
                    <ul class="pagination home-product-pagination">
                        ...
                        <li class="pagination-item"><a href="Tissot.php?page=<?php echo $current_page-1 ?>" class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-left"></i></a></li>
                            <?php } ?>
                            <?php 
                            for($page=1;$page<=$tongtrang;$page++){
                                echo  '<li class="pagination-item"> <a  id="page'.$page.'" href="Tissot.php?page='.$page.'" class="pagination-item__link ">'.$page.'</a> </li>' ;
                             }?>
                             <?php if($current_page<$tongtrang){?>
                        <li class="pagination-item"> <a href="Tissot.php?page=<?php echo $current_page+1 ?> " class="pagination-item__link"><i class="pagination-item__icon fas fa-angle-right"></i></a></li>      
                        <?php } ?>
