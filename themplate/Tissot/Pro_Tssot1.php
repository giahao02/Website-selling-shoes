                            ...
                            <form onclick="updatecart()">
                                <table>
                                    <tbody class="cart-items">
                                        <tr class="cart-row">
                                            <td><span class="title"> Tissot T097</span></td>
                                            <td><p><span class="prices" onclick="">9.800.000</span><sup>đ</sup></p></td>
            ...
            <div class="grid__row app__content">
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="product-slide" >
                        <div class="slide1"><img class="slide_img"  src="../Image/Tissot/Tissot T097.jpg"></div>
                        <div class="slide1"><img class="slide_img" src="../Image/Tissot/Tissot T097 1.jpg"></div>
                        <div class="slide1"><img class="slide_img"  src="../Image/Tissot/Tissot T097 2.jpg"></div>
                        <a class="prev" onclick="plusSlides(-1)">❮</a>
                        <a class="next" onclick="plusSlides(1)">❯</a>
                    </div>
                    <div class="picture-slide">
                        <div class="picture">
                            <div class="picture1"><img class="change-img" onclick="currentSlide(1);" src="../Image/Tissot/Tissot T097.jpg"></div>
                            <div class="picture1" ><img class="change-img" onclick="currentSlide(2);" src="../Image/Tissot/Tissot T097 1.jpg"></div>
                            <div class="picture1"><img class="change-img" onclick="currentSlide(3);"  src="../Image/Tissot/Tissot T097 2.jpg"></div>
                ...
                <div class="grid__column-6 product" style="width: 480px;">
                    <div class="heading-product">
                        <span>ĐỒNG HỒ TISSOT</span>
                    </div>
                    <div class="heading-product__name">
                        <span>Tissot T097</span>
                    </div>
                    ...
                    <div class="container-product">
                        <div class="container-product__price">9.800.000 VNĐ</div>
                    </div>
                    
                    <div class="description">
                        <p>Đồng Hồ Nam Dây Da <b>Tissot T097.407.26.053.00 - Đồng hồ Tissot</b> là 1 trong những thương hiệu đồng hồ quốc tế được những nhà sưu tập yêu thích nhất. Nằm trong top 5 thương hiệu đồng hồ tốt nhất thế giới với hơn 160 năm tồn tại và phát triển, đóng góp khá lớn cho nền công nghiệp sản xuất đồng hồ Thụy Sĩ thiết kế sang trọng mà cổ điển với chất lượng hoàn hảo.</p>
                    </div>
