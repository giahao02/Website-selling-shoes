...
<body onload="time()">
    ...
    <div class="container-fluid al">
        ...
        <div class="card-header">
           <h1 style="text-align:center;">Quản lý thông tin nhân viên</h1>
        </div>
            ...
            <table class="table table-bordered" id="myTable">
                ...
                while($row=mysqli_fetch_assoc($query5)){ ?>
                                ...
                                <td><?php echo  '&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;'.$i++; ?></td>
                                    <td  style="text-align:center;"><?php echo $row['idNV'] ?></td>
                                    ...
                                    <button><a style="color:red;" href="?chucnang=xoanv&idkh=<?php echo $row['idNV']?>">Xóa</a></button> 
