...
<head>
    ...
    <title>Casio MTP-VT01GL-2BUDF</title>
        ...
        <header class="header">
            <div class="header-with-search">
               ...
               <div class="header__logo">
                <a href="../index.html"><img class="logo" src="../Image/logo-dong-ho.png" alt=""></a>
               </div>
               <div class="header__search">
                ...
                <div class="header__cart">
                    <div class="header__cart-wrap"> <i class="header__cart-icon fas fa-shopping-cart"></i>
                        ...
                        <div class="header__cart-list"><span class="header__cart-no-cart-msg">Chưa có sản phẩm</span>
                            <h4 class="header__cart-heading">Sản phẩm đã thêm</h4>
                                <form onclick="updatecart()">
                                    <table>
                                        <tbody class="cart-items">
                                            <tr class="cart-row">
                                                <td><span class="title"> Casio MTP-VT01GL-2BUDF</span></td>
            ...
            <div class="grid__row app__content">
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="product-slide" >
                        <div class="slide1"><img class="slide_img"  src="../Image/Casio/Casio MTP-VT01GL-2BUDF.jpg"></div>
                        <div class="slide1"><img class="slide_img" src="../Image/Casio/CASIO-MTP-VT01GL-2BUDF-1.jpg"></div>
                        <div class="slide1"><img class="slide_img"  src="../Image/Casio/CASIO-MTP-VT01GL-2BUDF-2.jpg"></div>
                        <a class="prev" onclick="plusSlides(-1)">❮</a>
                        <a class="next" onclick="plusSlides(1)">❯</a>
                    </div>
                    <div class="picture-slide">
                        <div class="picture">
                            <div class="picture1"><img class="change-img" onclick="currentSlide(1);" src="../Image/Casio/Casio LTP-VT01GL-9BUDF.jpg"></div>
                            <div class="picture1" ><img class="change-img" onclick="currentSlide(2);" src="../Image/Casio/CASIO-MTP-VT01GL-2BUDF-1.jpg"></div>
                            <div class="picture1"><img class="change-img" onclick="currentSlide(3);"  src="../Image/Casio/CASIO-MTP-VT01GL-2BUDF-2.jpg"></div>
                ...
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="heading-product__name">
                        <span>Casio MTP-VT01GL-2BUDF</span>
                    </div>
                    ...
                    <div class="description">
                        <p>Mẫu <b>Casio MTP-VT01GL-2BUDF</b> phiên bản tone màu xanh chủ đạo trên phần dây da kiểu dáng trơn cùng với phần mặt số size 40 thiết kế đơn giản 3 kim, các cọc vạch số được tạo hình mỏng trẻ trung.</p>
                    </div>
