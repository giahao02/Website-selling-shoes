...
<head>
    ...
    <title>Casio LTP-VT01GL-9BUDF</title>
...
<body>
    <div class="sign"><a href="../sign/dangnhap.php">Đăng nhập</a>|<a href="../sign/sign.php">Đăng ký</a></div>
        ...
        <header class="header">
                            ...
                            <form onclick="updatecart()">
                                <table>
                                    <tbody class="cart-items">
                                        <tr class="cart-row">
                                            <td><span class="title"> Casio LTP-VT01GL-9BUDF</span></td>
                                            <td><p><span class="prices" onclick="">900.000</span><sup>đ</sup></p></td>
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a class="active" href="#">Đồng hồ </a>
                        <ul class="sub-menu">
            ...
            <div class="grid__row app__content">
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="product-slide" >
                        <div class="slide1"><img class="slide_img"  src="../Image/Casio LTP-VT01GL-9BUDF.jpg"></div>
                        <div class="slide1"><img class="slide_img" src="../Image/Casio LTP-VT01GL-9BUDF so1.jfif"></div>
                        <div class="slide1"><img class="slide_img"  src="../Image/Casio LTP-VT01GL-9BUDF so2.jfif"></div>
                        <a class="prev" onclick="plusSlides(-1)">❮</a>
                        <a class="next" onclick="plusSlides(1)">❯</a>
                    </div>
                    <div class="picture-slide">
                        <div class="picture">
                            <div class="picture1"><img class="change-img" onclick="currentSlide(1);" src="../Image/Casio LTP-VT01GL-9BUDF.jpg"></div>
                            <div class="picture1" ><img class="change-img" onclick="currentSlide(2);" src="../Image/Casio LTP-VT01GL-9BUDF so1.jfif"></div>
                            <div class="picture1"><img class="change-img" onclick="currentSlide(3);"  src="../Image/Casio LTP-VT01GL-9BUDF so2.jfif"></div>
                ...
                <div class="grid__column-6 product" style="width: 480px;">
                    ...
                    <div class="heading-product__name">
                        <span>Casio LTP-VT01GL-9BUDF</span>
                    </div>
                    ...
                    <div class="container-product">
                        <div class="container-product__price">900.000 VNĐ</div>
                    </div>
                    
                    <div class="description">
                        <p>Sản phẩm đang được bán tại Hà Nội, nên thời gian nhận hàng phụ thuộc vào địa chỉ nhận hàng của bạn. Mặc khác, shop bán Đồng Hồ Casio Nữ <b>LTP-VT01GL-9BUDF</b> Dây Da Chính hãng chưa được chứng thực bởi Shopee nên bạn cân nhắc qua điểm đánh giá, số sản phẩm đang bán, mức độ theo dõi và độ phản hồi trước khi khi đặt hàng</p>
                    </div>
                    <div style="font-weight: bold;">
                        <p>Trạng thái: còn hàng</p>
                    </div>
                    <div class="product-purchase">
                        <button class="btn product-purchase__buy">
    ...
    Mặt kính và vỏ: Fossil FS5404 được thiết kế với mặt kính nhựa. Vỏ đồng hồ cũng là một loại nhựa case/bezel (Resin) không chỉ nhẹ mà còn có khả năng chống sốc, dai nhưng lại cứng và rất bền, lâu lão hóa giúp chiếc đồng hồ bền lâu được cùng với thời gian. Vỏ đồng hồ điện tử được mạ vàng cao cấp tạo độ sang trọng cho người đeo.
